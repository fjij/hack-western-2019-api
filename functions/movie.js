...
function excludeGenres(expression) {
  var exclude = '';
  if (expression == 'angry') {
    exclude = '16,35,18,10751,36,27,10402,9648,10749,878,10770,53,10770,53,10752,37';
  } else if (expression == 'disgusted') {
    exclude = '28,12,16,35,18,10751,14,36,9648,10749,878,10770,10770,53,10752,37';
  } else if (expression == 'fearful') {
    exclude = '28,12,80,99,18,10751,14,36,10402,10749,878,10770,10770,53,10752,37';
  } else if (expression == 'happy') {
    exclude = '12,80,99,14,36,27,10402,9648,878,10770,53,10770,53,10752,37';
  } else if (expression == 'neutral') {
    exclude = '';
  } else if (expression == 'sad') {
    exclude = '28,12,35,80,99,18,14,36,27,9648,878,10770,53,10770,53,10752,37';
  } else if (expression == 'surprised') {
    exclude = '28,12,16,35,10751,14,36,27,10402,10749,878,10770,53,10770,53,37';
  }
  return exclude;
}
